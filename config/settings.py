...
MIDDLEWARE = [
    ...
    'accounts.middleware.BlockChatMediaMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'mentoring'),
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@mentorika.ru')
